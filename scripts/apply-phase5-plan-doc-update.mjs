...
const oldPhase5 = `### Phase 5：迁移高风险章节节点
...
const newPhase5 = `### Phase 5：迁移高风险章节节点
...
const currentNextStep = `## Current next step
...
Do not migrate `ch3_wrapup` yet. It must remain the final Chapter 3专项迁移对象.
