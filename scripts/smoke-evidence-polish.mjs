...
smokePresent('周怀安情感举证：日记残页', 'ch4_revisit_zhou', '日记残页', 'ch4_zhou_present_diary', [
  expectFlag('zhou_understands_wanting'),
  expectClue('周怀安理解苏晚亭选择'),
]);
smokePresent('周怀安情感举证：陈明远的信', 'ch4_revisit_zhou', '陈明远的信', 'ch4_zhou_present_letter', [
  expectFlag('zhou_accepts_chen_link'),
  expectClue('周怀安面对陈明远的信'),
]);
smokePresent('周怀安情感举证：三人合影', 'ch4_revisit_zhou', '三人合影', 'ch4_zhou_present_photo', [
  expectFlag('zhou_recognizes_guanghua_photo'),
  expectClue('周怀安认出光华合影'),
]);
