    ...
    if (nodes.ch1_take) {
      ...
      nodes.ch1_take.text = function (state) {
        if (E.getFlag('echo_zhou_questioned_first')) {
          return `你把信封推过来，指腹触到纸面的厚度——不是轻飘飘的铞票，是银元，一块块沉甸甸的金属，隔着牛皮纸仍能感到那种冰凉的、属于硬通货的质感。你把它收进大衣内袋，银元与衣料摩擦，发出极轻的篸笤声。<br><br>你在心里回想周怀安刚才的描述：圣约翰大学英文系学生，论文题目是《简·奥斯汀作品中的女性意识》，失踪前半个月常晚归，有个穿黑衣服的男人来找过她。你没有她的近照——周怀安说她不常照相，学校才是第一站。<br><br><span class="sys">“我会找到她的。”</span><br><br>周怀安站起来，深深鞠了一鞬。他的长衫下摆沾着室外的雨渍，深一块浅一块。他转身走向门口，推开那扇咛哑作响的木门，走进雨里。你没有立刻站起来，而是隔着茶馆的玻璃窗看着他的背影——一个穿灰色长衫的男人，在霞飞路的雨幕中渐渐缩成一个模糊的轮廓，然后拐过街角，不见了。雨把他的脚印冲刷得干干净净，仿佛他从未来过。<br><br>茶馆里只剩下你一个人。伙计在柜台后面打盾，炉上的水开了，咕噜咕噜响着，没人去提。你盯着桌面发呆。周怀安留给你的信息不算多，但也不算少。圣约翰大学、苏家、巡捕房——三条路，总有一条能先摸到边。<br><br>窗外雨声绵密。上海入秋以来就没晴过几天，整个城市像泡在一壶凉透了的茶里。你喝完最后一口茶，决定行动的方向。<br><br>你决定先去哪里？`;
        }
        return typeof oldTakeText === 'function' ? oldTakeText(state) : oldTakeText;
      };
    }
