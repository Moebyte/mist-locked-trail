...
function applyGameplayImprovements() {
  ...
  nodes.end_conspiracy_detail = {
    ...
    text: () => {
      ...
      return `所有的碎片都拼上了。<br><br>陈明远发现光华小学的管制药品走私——被灭口。<br>沈玉芳从他那里知道了一部分真相——被关在福生仓。<br>陆念薇是中间人——她被杭州旧案捏住脖子，不是主谋。<br>傅启元在码头亲自现身——蓝封公文夹终于有了主人。<br><br>${suLine}<br><br>你没有只写一份报案材料。你写了三份：一份交给老孙，一份寄给《申报》，一份锁进银行保险柜。<br><br>三天后，《申报》头版刊出报道：《光华小学教具箱暗藏管制药品，法租界码头仓库涉非法转运》。<br><br>报道第一次点出了傅启元的名字。<br><br>又过了三天，福生仓被查封。傅启元以“协助调查”的名义被带走。公董局没有承认任何事，但他们也没能让这件事完全消失。<br><br>一个月后，你收到一封信。信上只有一行字：<br><br><span class="sys">"沈先生，谢谢你先找人，而不是先找凶手。——苏晚亭"</span><br><br>窗外又下雨了。你泡了一壶新茶。<br><br>民国三十七年的冬天，比往年来得都晚一些。但终究是来了。<br><br><div style="color:#666;font-style:italic;margin-top:20px">—— 结局七 · 雨夜灯火（隐藏结局）——</div>`;
    },
    type: 'end'
  };
  ...
  nodes.end_rescue = {
    title: '结局 · 雨夜灯火',
    text: () => `你没有急着写报告。<br><br>你先把人送去了医院。<br><br>沈玉芳在病床上睡了整整一天。苏晚亭如果被你从福生仓带出，也一直到第二天清晨才真正醒来。她醒来后的第一句话仍是：<br><br><span class="sys">"陈老师……他是不是已经死了？"</span><br><br>你点了点头。<br><br>她没有哭。只是把脸转向窗外，过了很久才说：<span class="sys">"那就别让他白死。"</span><br><br>陆念薇跑了，赵先生也跑了，傅启元仍然会找办法把自己洗干净。但这一次，他们没来得及灭口。<br><br>两个月后，苏晚亭离开上海。她临走前托周明远给你送来一封信，信里只有一句话：<br><br><span class="sys">"沈先生，谢谢你先找人，而不是先找凶手。"</span><br><br>案子没有真正结束。但那一夜，至少有两盏灯没有灭。<br><br><div style="color:#666;font-style:italic;margin-top:20px">—— 结局五 · 雨夜灯火 ——</div>`,
    type: 'end'
  };
}
